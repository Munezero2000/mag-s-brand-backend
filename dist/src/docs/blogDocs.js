...
const BlogDocs = {
    "/api/blogs": {
        get: Object.assign({ summary: "Get a list of all blogs" }, listBlogs),
        post: Object.assign({ summary: "Create a new blog post" }, createBlog),
    },
    "/api/blogs/{id}": {
        get: Object.assign({ summary: "Get a single blog post by ID" }, getOneBlogById),
        put: Object.assign({ summary: "Update an existing blog post" }, putBlog),
        delete: Object.assign({ summary: "Delete an existing blog post" }, deleteBlog),
    },
};
exports.default = BlogDocs;
//# sourceMappingURL=blogDocs.js.map